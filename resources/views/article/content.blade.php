    ...
    <div id="Main">
        ...
        <div class="box" style="border-bottom: 0px;">
            <div class="header">
                ...
                <a href="/">DEBUG</a><span class="chevron"> › </span><a
                        href="/?type={{ $article->sorts}}">{{ $article->sorts}}</a>
                <div class="sep10">
                </div>
                <h1>{{ $article->title}}</h1>
                 
                <small class="gray"><a
                            href="/user/home/{{ $article->user->nickname }}">{{ $article->user->nickname }}</a>
                    · {{ $article->created_at }} · {{ $article->views }} 次点击  
                </small>
            </div>
            <div class="cell">
                ...
                {{--<table cellpadding="0" cellspacing="0" border="0" width="100%">--}}
                    {{--<tr>--}}
                        {{--<td width="48" valign="top" align="center">--}}
                            {{--<img src="//cdn.v2ex.com/gravatar/30e86f9f5e3b40e038cddcbc5523d0af?s=48&d=retro"--}}
                        ...
                        {{--<td width="auto" valign="top" align="left">--}}
                            {{--<div class="fr">--}}
                                {{--  <a href="#;" onclick="replyOne('wolfie');">--}}
                                    {{--<img src="//cdn.v2ex.com/static/img/reply.png" align="absmiddle" border="0"--}}
                                         {{--alt="Reply"/></a>   --}}
...
@section('js')
    <script>
        function replyOne(name) {
            $('textarea[name=content]').text("").text("@" + name + "  ");
